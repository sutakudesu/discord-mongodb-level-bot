...
mongoose.connect(`MongoDB Connect URL`, {useNewUrlParser: true, useUnifiedTopology: true, useFindAndModify: false}).then(c => console.log(`MongoDB connected!`)).catch(err => console.error(`Failed to connect to MongoDB!`));
